...
//  using only multiplications (instead of  multiplications required by the naive approach).
...
int binary_exponentiation(int a, int b) {
    if(b == 0) return 1;
    int result = binary_exponentiation(a, b/2);
...
// #endif
    ...
    while (t--) {
        ...
        cout << "Base: "; cin >> c;
        cout << "Power: "; cin >> b; 
        cout << binary_exponentiation(c,b) << endl;
        }
